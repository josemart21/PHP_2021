            ...
            <ul class="nav navbar-nav">
              <li class="<?= esOpcionMenuActiva('index') ? 'active' : '' ?> lien">
                ...
                <li class="<?= esOpcionMenuActiva('about') ? 'active' : '' ?> lien">
                  <a href="<?= esOpcionMenuActiva('about') ? '#' : '/about' ?>">
                      <i class="fa fa-bookmark sr-icons"></i> About
                  </a>
              </li>
                <li class="<?= existeOpcionMenuActivaEnArray(['blog','post']) ? 'active' : '' ?> lien">
                ...
                <li class="<?= esOpcionMenuActiva('contact') ? 'active' : '' ?> lien">
                  <a href="<?= esOpcionMenuActiva('contact') ? '#' : '/contact' ?>">
                ...
                <li class="<?= esOpcionMenuActiva('asociados') ? 'active' : '' ?>">
                    <a href="<?= esOpcionMenuActiva('asociados') ? '#' : '/asociados' ?>">
